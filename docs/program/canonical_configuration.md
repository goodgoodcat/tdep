...
For example, 10 MD runs of 1000 time steps explores phase space better than a single MD run of 10x1000 time steps, as shown by singular value decomposition of molecular dynamics trajectories.
